...
export const MOVIES_SEARCH_RESET = 'MOVIES_SEARCH_RESET';

export const MOVIE_DELETE_LOCALLY = 'MOVIE_DELETE_LOCALLY';
export const MOVIE_CREATE_LOCALLY = 'MOVIE_CREATE_LOCALLY';
