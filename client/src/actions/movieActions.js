...
import { MOVIES_SEARCH, MOVIE_CREATE_FAIL, MOVIE_CREATE_REQUEST, MOVIE_CREATE_SUCCESS, MOVIE_DELETE_FAIL, MOVIE_DELETE_REQUEST, MOVIE_DELETE_SUCCESS, MOVIE_LIST_FAIL, MOVIE_LIST_REQUEST, MOVIE_LIST_SUCCESS, MOVIE_SIGNAL_TO_SEARCH } from '../constants/movieConstants';
...
export const createMovie = ({ title, releaseYearDate, format, stars }) => async (dispatch) => {
    try {
        dispatch({
