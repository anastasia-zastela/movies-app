...
const Header = () => {
    ...
    const onClickSearchHandler = (e) => {
        ...
        const filteredMoviesArr = movies
            .filter(mov => {
                let boolean;
                const filteredActors = mov.stars.map(st => st.toLowerCase().indexOf(userInput.toLowerCase()) !== -1)
    ...
    return (
        <header>
            ...
            <Navbar bg="dark" variant="dark" expand="lg">
                <Container>
                    <Navbar.Brand style={{ cursor: 'pointer' }} onClick={onClickLogoHandler}>Movies Search App</Navbar.Brand>
